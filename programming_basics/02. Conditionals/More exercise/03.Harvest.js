function harvest(input) {
    ...
    if (oneLiterWine < litersOfWine) {
        console.log(`It will be a tough winter! More ${Math.floor(Math.abs(remainder))} liters wine needed.`);
    } else if (wine >= litersOfWine) {
        console.log(`Good harvest this year! Total wine: ${Math.floor(oneLiterWine)} liters.`);
